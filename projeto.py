...
class MM_ImageProcessing:
	...
	entry2.show()
        ...
        label = gtk.Label("Read Path")
        box.pack_start(label,False,False,3)
        entry1 = gtk.Entry()#entry.set_max_length(50)
        entry1.set_text("/home/edelgado/Desktop/projeto/imagens/g40x/grupo1")
        entry1.set_size_request(100, 20)
        box.pack_start(entry1,False,False,3)
        label.show()
        entry1.show()

        label = gtk.Label("Save Path")
        box.pack_start(label,False,False,3)
        entry2 = gtk.Entry()#entry.set_max_length(50)
        entry2.set_text("/home/edelgado/Desktop/projeto/imagens/g40x/dissertacao/fase00")
        entry2.set_size_request(100, 20)
        box.pack_start(entry2,False,False,3)
        label.show()
        entry2.show()
        ...
        box.pack_start(label,False,False,3)
        entry1 = gtk.Entry()#entry.set_max_length(50)
        entry1.set_text("/home/edelgado/Desktop/projeto/imagens/g40x/dissertacao/fase00")
        entry1.set_size_request(100, 20)
        box.pack_start(entry1,False,False,3)
        label.show()
        entry1.show()
        ...
        box.pack_start(label,False,False,3)
        entry2 = gtk.Entry()#entry.set_max_length(50)
        entry2.set_text("/home/edelgado/Desktop/projeto/imagens/g40x/dissertacao/fase01")
        entry2.set_size_request(100, 20)
        box.pack_start(entry2,False,False,3)
        label.show()
        entry2.show()
        ...
        box.pack_start(label,False,False,3)
        entry1 = gtk.Entry()#entry.set_max_length(50)
        entry1.set_text("/home/edelgado/Desktop/projeto/imagens/g40x/dissertacao/fase01")
        entry1.set_size_request(100, 20)
        box.pack_start(entry1,False,False,3)
        label.show()
        entry1.show()
        ...
        box.pack_start(label,False,False,3)
        entry2 = gtk.Entry()#entry.set_max_length(50)
        entry2.set_text("/home/edelgado/Desktop/projeto/imagens/g40x/dissertacao/fase02")
        entry2.set_size_request(100, 20)
        box.pack_start(entry2,False,False,3)
        label.show()
        entry2.show()
